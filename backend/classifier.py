...
TRAVEL_PERIOD_KEYWORDS = ["개월", "주", "일", "전", "후", "기간"]
...
def classify_query(query: str) -> dict:
    ...
    """
    matched = [k for k in COMPLEX_INDICATORS if k in query]
    has_travel = any(k in query for k in ["여행", "다녀왔", "방문", "출국", "귀국", "해외"])
    has_period = any(k in query for k in TRAVEL_PERIOD_KEYWORDS)
